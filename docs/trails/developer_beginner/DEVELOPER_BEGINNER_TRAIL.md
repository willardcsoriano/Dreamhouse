# Trailhead Trail Dashboard: Developer Beginner

**Trail Name:** Developer Beginner  
**Description:** Learn the basics of how to develop apps on the Salesforce Platform.  
**Total Points:** 11,900 Points  
**Progress:** **40% Completed (4 / 10 Badges)**  
...
```text
[████████████████████░░░░░░░░░░░░░░░░░░░░] 40% Completed (4/10 Badges)
```

---

## Badges Syllabus Index

|   #    | Badge Name                                     | Points |   Est. Time    |             Status             | Badge Documentation Link                                                                                                            |
| :----: | :--------------------------------------------- | :----: | :------------: | :----------------------------: | :---------------------------------------------------------------------------------------------------------------------------------- |
...
| **08** | **Apex Basics & Database**                     | +2,100 | ~2 hrs 45 mins |           ⏸️ Pending           | **[badges/08_apex_basics/](badges/08_apex_basics_and_database/APEX_BASICS_AND_DATABASE.md)**                                        |
| **09** | **Apex Triggers**                              | +1,000 | ~1 hr 30 mins  |           ⏸️ Pending           | **[badges/09_apex_triggers/](badges/09_apex_triggers/APEX_TRIGGERS.md)**                                                            |
| **10** | **Lightning Web Components Basics**            | +1,300 | ~1 hr 10 mins  |           ⏸️ Pending           | **[badges/10_lwc_basics/](badges/10_lightning_web_components_basics/LIGHTNING_WEB_COMPONENTS_BASICS.md)**                           |

---

## Execution & Branching Standard for this Trail

All developer activities within this trail follow the **[Global Badge Git Branching Protocol](badges/README.md#mandatory-git-version-control--feature-branching-protocol)**:

1. Work is isolated on dedicated feature branches (`feature/<badge-unit-name>`).
2. Schema XML, Apex code, and technical documentation are developed atomically.
3. Code is shipped to `master` strictly through Pull Requests (`gh pr create` & `gh pr merge`).
